...
public class GroupFreeController {

	Logger log = LoggerFactory.getLogger(GroupFreeController.class);
	@RequestMapping(value = "/groupfree", method = RequestMethod.POST)
	public WebRestResponse groupfree(@RequestParam("groupname") String gname){
		...
		String url = "http://223.22.252.52:803/group/free";

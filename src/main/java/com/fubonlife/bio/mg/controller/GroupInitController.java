...
public class GroupInitController {

	Logger log = LoggerFactory.getLogger(GroupInitController.class);
	@RequestMapping(value = "/groupinit", method = RequestMethod.POST)
	public WebRestResponse groupinit(@RequestParam("groupname") String gname){

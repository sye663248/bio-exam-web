...
public class GroupCleanController {

	Logger log = LoggerFactory.getLogger(GroupCleanController.class);
	@RequestMapping(value = "/groupclean", method = RequestMethod.POST)
	public WebRestResponse groupclean(@RequestParam("groupname") String gname){

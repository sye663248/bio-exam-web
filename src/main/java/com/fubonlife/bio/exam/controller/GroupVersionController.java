...
public class GroupVersionController {
	...
	Logger log = LoggerFactory.getLogger(GroupVersionController.class);
	@RequestMapping(value = "/groupversion", method = RequestMethod.GET)
	public WebRestResponse groupversion(){

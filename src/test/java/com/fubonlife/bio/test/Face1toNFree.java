...
public class Face1toNFree {

	Logger log = LoggerFactory.getLogger(Face1toNFree.class);
	...
	public void test01() throws Exception {
		...
		ResponseEntity<NFree> response = restTemplate.postForEntity(url, requestEntity,NFree.class);
